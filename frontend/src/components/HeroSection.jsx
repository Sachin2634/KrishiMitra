  ...
  return (
    <div className="w-full h-auto bg-[#FFFFFF] flex flex-col md:flex-row mb-[25px]">
      <div className="p-4 md:p-[80px] md:pr-[15vw]">
        ...
        <div className="inter-regular mt-4 md:mt-[49px] w-full md:w-[334px] h-auto md:h-[152px] text-[18px] md:text-[31px]">
          “Your Gateway to Fair Prices, Direct Market Access, and a Brighter Future in Farming!"
        </div>
        <button className="mt-6 md:mt-[70px] p-4 md:p-[10px] md:pl-[22px] md:pr-[22px] bg-[#006A30] text-[20px] md:text-[40px] text-white rounded-[30px] md:rounded-[22px]">
          Start Selling
        </button>
      </div>
