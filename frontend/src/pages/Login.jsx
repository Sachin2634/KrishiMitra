...
import { useNavigate } from 'react-router-dom';  // not 'react-router'
    ...
    <div className="w-full bg-cover bg-center h-screen flex justify-center bg-fixed bg-no-repeat" 
      ...
      <form
        ...
        <input
          ...
          className='w-[550px] h-auto pl-[42px] mt-[39px] pb-[18px] text-white text-[29px] 
            placeholder-white border-b-[3px] border-b-black'
        />
        <input
          type="password"
          name="password"
        ...
        <div>
          <button type="submit"
            className='mt-20 bg-white pl-[20px] pr-[20px] pt-[10px] pb-[10px] rounded-[20px] 
            text-[30px] hover:bg-white/80 cursor-pointer'>
            Proceed
          </button>
          <a href="/signup" className='text-white text-[20px] ml-[10px] hover:text-white/80'>
            Create Account?
          </a>
        </div>
      </form>
